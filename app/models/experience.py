...
class ExperienceRange(Base):
    ...
    topic_ranges = relationship("TopicExperienceRange", back_populates="experience_range", cascade="all, delete-orphan")
...
class TopicExperienceRange(Base):
    ...
    experience_range_id = Column(Integer, ForeignKey("experience_ranges.id"), nullable=False)
    topic = relationship("Topic", back_populates="experience_ranges")
